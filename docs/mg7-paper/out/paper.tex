...
consistency of taxonomic assignments. We run MG7 using this set of
sequences as query, with reference all but the one we are trying to
assign. Under the (reasonable) assumption of 16S sequence similarity
being correlated with the taxonomy tree topology, the MG7 result should
either
...
\item
  ...
  sequences similar enough in the reference database
\item
...
discarded. What we consider as close is: the parent of the MG7
assignment should be contained in the lineage of the original
assignment.
