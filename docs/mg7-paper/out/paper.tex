...
\item
  are annotated as being of \texttt{rRNA} type\footnote{We are aware of
    the existence of a gene annotation corresponding to 16S, that we are
    \textbf{not using} due to a significant amount of 16S sequences
    lacking the corresponding annotation}
\item
