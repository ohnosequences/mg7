...
[Loquat][loquat] is a library developed by *AA*, *EK* and *EP-T* designed for the execution of embarrassingly parallel tasks using S3, SQS and EC2 Amazon services.
