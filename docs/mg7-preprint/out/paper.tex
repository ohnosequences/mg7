...
\lhead{\titlefont MG7: Configurable and scalable 16S metagenomics data analysis}
...
the spirit of \autocite{harper1990extensible}
\autocite{harper1991record}. For that \emph{Datasets} uses
...
\autocite{magovc2011flash} and
\href{https://github.com/ohnosequences/blast}{BLAST}
\autocite{camacho2009blast} expressions and their execution.
...
\item
  ...
  \autocite{kovach2014nispero}) and \emph{aws-scala-tools}.
\item
