...
Database } %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
...
\citep[\citet{morgan2012chapter}]{segata2013computational} as a very
...
LCA assignment algorithms because it provides fine and trusted
...
\item
  \textbf{MM} MG7 workflow design; curation and design for the 16S-DB7
  reference database; wrote the paper.
\item
  \textbf{PPT} curation, design, data extraction code for the 16S-DB7
  reference database.
\item
  \textbf{EP} MG7 workflow design; wrote the paper.
\item
  \textbf{RT} MG7 workflow design, assignment strategy; curation and
  design for the 16S-DB7 reference database; wrote the paper.
\item
