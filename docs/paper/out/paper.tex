...
it. When using Amazon Web Services for parallel computations, it is easy
to scale the computation resources, because the you pay for the time,
not the amount of computation units.
